...
### 🛩️프로젝트 결과물 시연 영상 및 실행파일 & 프로젝트 pdf파일 다운로드 경로 
...
gantt
	...
	section 디버깅 및 병합 과정
		...
		해당 코드 영상처리 코드와 병합 :2024-02-23, 2d
	...
	section 발표
		시연 영상 제작 : 2024-02-26, 1d
		발표 자료 준비 : crit, 2024-02-26, 1d
...
| 안건        | 내용                                       | 결정사항                             |
|------------|--------------------------------------------|--------------------------------------|
| 기술 요약 페이지 추가 내용 검토 | 추가할 부분을 모색한 후 논의 | 핵심 기술 요약 부분 추가 <br> Gantt Chart 작성 |
| 최종 시연 영상 시나리오 회의 | 최종 시연 영상에 관한 제작 방향성 논의 | 모션 인식을 종합하여 영상 제작 <br> 다양한 모션 인식이 포함될 수 있도록 시나리오 작성 |
| 좌클릭에 관한 기능적인 부분 논의 | 좌클릭에 관한 기능적 코드 수정 <br> (손동작을 바꾸기 위함) | 기각 (기존 퍼포먼스의 용이함) |

### 파이널 프로젝트 회의 | 2024-02-27 | 참석자: 김승환, 김용철, 임선웅

| 안건        | 내용                                       | 결정사항                             |
|------------|--------------------------------------------|--------------------------------------|
| 시연 | 시연 영상에 AI음성 더빙 수록 <br> 시연자 영상 추가 | 시연영상 수정사항 논의 및 최종검토 |
| 발표 사항 | 발표 자료 준비 및 발표 시나리오 논의 | 발표자 : 김용철 <br> 보조 : 김승환, 임선웅 |
...
|2024-02-26|김승환|- main코드 최종 검토 및 실행파일 생성<br> - 배포를 위해 드라이브에 업로드|
|2024-02-26|김승환 <br> 김용철 <br> 임선웅| - 최종 프로세스 시연 영상 제작 <br> - Document 최종 검토 |
