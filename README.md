...
|2024-02-21|김용철|- 마우스 이동 및 마우스 좌클릭 완료|
...
|날짜|문제점|해결 방안|해결 여부|
|---|---|---|---|
|2024-02-22| - 손동작으로 인한 손가락 마커의 각도 인식 오류 <br> - 스크린 화면에 출력되는 HandMouse 이동의 불편함 | (해결 방안을 작성) | 미해결(담당자: 김용철) |
|2024-02-23| - 마우스 커서의 높은 딜레이 | 스레드 구현 | 해결(김승환) | 
|2024-02-23| - 마우스 스크롤 속도의 늦음 | 코드 수정 | 해결(임선웅) |
|2024-02-23| - Backspace, Enter키의 부재 | 코드 구현 | 해결(김승환) |
<br>
