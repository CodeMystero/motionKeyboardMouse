...
gantt
	...
	section 손동작 인식 마우스 제어
		...
		모션 인식 마우스 이동 및 마우스 좌클릭 코드 작성 드래프트 완료 : 2024-02-21, 1d
		모션 인식 마우스, 스크롤 업& 다운 코드 작성 드래프트 완료 : 2024-02-21, 1d
		모션 인식 마우스 우클릭 및 음성인식 트리거 코드 작성 드래프트 완료 : 2024-02-22, 1d
		손 인식 알고리즘 최적화 : 2024-02-22, 1d

	section 디버깅 및 병합 과정
		모션 인식 카메라와 디스플레이 맵핑 최적화 : crit, 2024-02-22, 1d
```
...
|날짜|문제점|해결 방안|해결 여부|
|---|---|---|---|
|2024-02-22| - 손동작으로 인한 손가락 마커의 각도 인식 오류 <br> - 스크린 화면에 출력되는 HandMouse 이동의 불편함 | - 손가락 마카의 기준점을 변경하여 각도 문제 해결 <br> - 모션인식 카메라와 디스플레이 맵핑 최적화로 문제 해결 | 미해결(담당자: 김용철) |
