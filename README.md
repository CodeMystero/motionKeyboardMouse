...
|날짜|문제점|해결 방안|해결 여부|
|---|---|---|---|
|2024-02-22| - 손동작으로 인한 손가락 마커의 각도 인식 오류 <br> - 스크린 화면에 출력되는 HandMouse 이동의 불편함 | - 손가락 마카의 기준점을 변경하여 각도 문제 해결 <br> - 모션인식 카메라와 디스플레이 맵핑 최적화로 문제 해결 | 해결(김용철) |
|2024-02-23| - 마우스 커서의 높은 딜레이 | 스레드 구현 | 해결(김승환) | 
|2024-02-23| - 마우스 스크롤 속도의 늦음 | scr_speed 코드 수정 | 해결(임선웅) |
|2024-02-23| - Backspace, Enter 기능의 부재 | finger==1, finger==4 코드 구현 | 해결(김승환) |
<br>
