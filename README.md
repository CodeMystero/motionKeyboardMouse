...
gantt
	...
	section 손동작 인식 마우스 제어
		...
		모션 인식 마우스 이동 및 마우스 좌클릭 코드 작성 : 2024-02-21, 2d
		모션 인식 마우스, 스크롤 업& 다운 코드 작성 : 2024-02-21, 2d
		모션 인식 마우스 우클릭 및 음성인식 트리거 코드 작성  : 2024-02-21, 2d
		손 인식 알고리즘 최적화 : 2024-02-22, 1d
...
| 안건        | 내용                                       | 결정사항                             |
|------------|--------------------------------------------|--------------------------------------|
| 개선 방안 | 동작인식 오류에 대한 방안 제시 | 반복적인 시뮬레이션을 통해 방안 모색 |
| 프로세스 계획 | 로딩창, UI 이미지에 대한 논의 | 적합한 디자인 색출 |
...
|2024-02-22|임선웅|- 깃허브 README 수정 <br> - Gantt Chart 작성 <br> - 3차 회의록 안건 작성 <br> - 발견된 문제점, 해결 방안과 여부 등록 <br> - 모션 사용법 (scroll up, down, exit) 추가 <br> - 프로세스 퀄리티 검토|
...
# 실사용에 발견된 문제점 | 디버그 담당자: 임선웅

|날짜|문제점|해결 방안|해결 여부|
|---|---|---|---|
|2024-02-22| - 손동작으로 인한 손가락 마커의 각도 인식 오류 <br> - 스크린 화면에 출력되는 HandMouse 이동의 불편함 | - 손가락 마카의 기준점을 변경하여 각도 문제 해결 <br> - 모션인식 카메라와 디스플레이 맵핑 최적화로 문제 해결 | 해결 <br> (김용철) |
|2024-02-23| - 마우스 커서의 높은 딜레이 | 스레드 구현 | 해결 <br> (김승환) | 
|2024-02-23| - 마우스 스크롤 속도의 늦음 | scr_speed 코드 수정 | 해결 <br>(임선웅) |
|2024-02-23| - Backspace, Enter 기능의 부재 | finger==1, finger==4 코드 구현 | 해결 <br> (김승환) |
<br>
